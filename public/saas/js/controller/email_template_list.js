  ...
  function($rootScope, $scope, $location, $http) {
    $scope.emailTemplateList = function() {
      ...
      $scope.email_templates = [
        ...
        {email_type:"offer_confirm_notice_email", name: "Edit Offer Confirmed Notice email", pop_text: "Applicants receive this email after they accepted an assignment of a position."},
        // About post match
